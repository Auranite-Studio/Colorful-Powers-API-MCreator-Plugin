...
import com.esmods.cpapi.element.types.Artifact;
import com.esmods.cpapi.Launcher;

public class ArtifactGUI extends ModElementGUI<Artifact> {
    ...
    public void reloadDataLists() {
        ...
        ComboBoxUtil.updateComboBoxContents(renderType, ListUtils.merge(Arrays.asList(ArtifactGUI.builtinitemmodels), (Collection)Model.getModelsWithTextureMaps(this.mcreator.getWorkspace()).stream().filter((el) -> {
    ...
    @Override
    public void openInEditingMode(Artifact item) {
    ...
    public Artifact getElementFromGUI() {
        Artifact item = new Artifact(this.modElement);
